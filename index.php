...
?>
                        ...
                        <div class="welcome-intro">
                            ...
                            <div class="button-group">
                                <a href="contact.php" class="btn btn-bordered-white">Roʻyxatdan oʻtish</a>
                            </div>
                        </div>
                    </div>
...
?>
 ...
 <!-- Portfolio Items -->
                <div class="row1 items portfolio-items">
...
?>
                ...
                <div class="row1 justify-content-center">
                    <a href="portfolio" class="btn btn-bordered mt-4">Qoʻshimcha</a>
                </div>
            </div>
        </section>
        <!-- ***** Portfolio Area End ***** -->
