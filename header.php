...
?>
                    ...
                    <a class="navbar-brand" href="index.php">
                        <img class="navbar-brand-regular" src="dashboard/uploads/logo/logo1.png" style="height:65px" alt="brand-logo">
                        <img class="navbar-brand-sticky" src="dashboard/uploads/logo/logo1.png" style="height:65px"  alt="sticky brand-logo">
                    </a>
                    ...
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item">
                            <a href="portfolio" class="nav-link">Kurslar</a>
                        </li>
                        <li class="nav-item">
                            <a href="contact" class="nav-link">Aloqa</a>
                        </li>
                        <li class="nav-item">
                            <a href="dashboard" class="btn ml-lg-auto btn-bordered">Administrator</a>
                        </li>
                    </ul>
                    <!-- Navbar Icons -->
