...
?>
                        <a  href="../index.php" class="d-block">
                          <img  src="uploads/logo/logo2.svg" alt="" height="50">
                        </a>
                      </div>
                ...
                <div class="col-lg-6">
                  <div class="p-lg-5 p-4">
                    <div>
                      ...
                      <p class="text-muted">Boshqaruv panelida davom etish uchun tizimga kiring.</p>
                    </div>
                    ...
                    <?php
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="username" name="username" placeholder="Foydalanuvchi nomi">
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="position-relative auth-pass-inputgroup mb-3">
                            <input type="password" class="form-control pe-5" name="password" placeholder="Parol"
                              id="password-input">
