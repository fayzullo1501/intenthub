                                    ...
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                                <i class="fas fa-home"></i> Add Course
                                            </a>
                                        </li>
...
$msg=$msg."Course Title Must Be More Than 5 Char Length.<BR>";
$status= "NOTOK";}
 if ( strlen($port_desc) > 150 ){
$msg=$msg."Course description Must Be Less Than 150 Char Length.<BR>";
$status= "NOTOK";}

if ( strlen($port_detail) < 15 ){
  $msg=$msg."Course Detail Must Be More Than 15 Char Length.<BR>";
  $status= "NOTOK";}
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="port_title" placeholder="Enter Course Title">
                                                        </div>
                                                    </div>
