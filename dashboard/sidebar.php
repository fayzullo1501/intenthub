...
?>
    ...
    <a href="index.html" class="logo logo-dark">
      <span style="text-align:center;" class="logo-sm">
    ...
    <a href="index.php" class="logo logo-light">
      <span class="logo-sm">
        <img src="uploads/logo/logo3.svg" style="height:25px" alt="" height="22">
      </span>
      <span class="logo-lg">
        <img src="uploads/logo/logo2.svg" style="height:60px" alt="" height="30">
      </span>
    </a>
  ...
  <div id="scrollbar">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
                <a href="dashboard" class="nav-link" data-key="t-analytics">  <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards"> Admin Panel </span></a>
              </li>
             ...
             <!-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarLanding" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                                <i class="ri-checkbox-multiple-line"></i> <span data-key="t-landing">Blog & News</span>
                            </a>
                            <div class="menu-dropdown collapse" id="sidebarLanding" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="createservice" class="nav-link" data-key="t-one-page">Add </a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarPot" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                                <i class="ri-rhythm-fill"></i> <span data-key="t-landing">Courses</span>
                            </a>
                            <div class="menu-dropdown collapse" id="sidebarPot" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="createportfolio" class="nav-link" data-key="t-one-page"> Add </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="portfolio" class="nav-link" data-key="t-nft-landing">List</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarT" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                                <i class="ri-message-line"></i> <span data-key="t-landing">Personal</span>
                            </a>
                            <div class="menu-dropdown collapse" id="sidebarT" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="newtestimony" class="nav-link" data-key="t-one-page">Add</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarSl" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                                <i class="ri-image-fill"></i> <span data-key="t-landing">Baner</span>
                            </a>
                            <div class="menu-dropdown collapse" id="sidebarSl" style="">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="static" class="nav-link" data-key="t-nft-landing"> Edit</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                       ...
                       <!-- <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarX" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                                <i class="ri-chrome-fill"></i> <span data-key="t-landing">Ijtimoiy Tarmoqlar</span>
                            </a>
                            <div class="menu-dropdown collapse" id="sidebarX" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="createsocial" class="nav-link" data-key="t-one-page"> Qo'shish </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="social" class="nav-link" data-key="t-nft-landing">Ro'yxat </a>
                                    </li>
                                </ul>
                            </div>
                        </li>-->
                        ...
                        <li class="nav-item">
                            ...
                            <div class="menu-dropdown collapse" id="sidebarK" style="">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="sections" class="nav-link" data-key="t-nft-landing">Sections</a>
                                    </li>
                                    <!--<li class="nav-item">
                                        <a href="logo" class="nav-link" data-key="t-nft-landing"> Logotip </a>
                                    </li>-->
                                    <li class="nav-item">
                                        <a href="contact" class="nav-link" data-key="t-nft-landing">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
