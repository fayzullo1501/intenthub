                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Add (Blog & News)</h4>
                                    ...
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                                <i class="fas fa-home"></i> Add Blog & News
                                            </a>
                                        </li>
...
$msg=$msg."Blog & News Title Must Be More Than 5 Char Length.<BR>";
$status= "NOTOK";}
...
if ( strlen($service_detail) < 15 ){
  $msg=$msg."Blog & News Detail Must Be More Than 15 Char Length.<BR>";
  $status= "NOTOK";}
   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <button type="submit" name="save" class="btn btn-primary">Add Blog & News</button>
