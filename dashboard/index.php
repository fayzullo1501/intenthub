...
?>
                                                        ...
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1">Blog & News</p>
...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1">Courses</p>
...
?>
                                                        <p class="text-uppercase fw-semibold fs-12 text-muted mb-1">Team</p>
